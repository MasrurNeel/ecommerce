...
<?php partial_view('_notification')?>
        <form action="/dashboard/products/edit/<?php echo $product->id; ?>" class="form" method="post" enctype="multipart/form-data">
            <div class="from-group">
                ...
                <input type="text" value="<?php echo $product->title; ?>" name="title" placeholder="Enter Title" class="form-control">
            </div>
            <div class="from-group">
            ...
            <div class="form-group">
                ...
                <?php if($product->product_photo):?>
                    <img width="50" alt="<?php echo $product->title;?>" src="/media/products/<?php echo $product->product_photo->image_path;?>"
                    >
                <?php endif;?>
            </div>
            <div class="from-group">
